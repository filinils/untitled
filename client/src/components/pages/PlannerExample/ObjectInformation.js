...
class ObjectInformation extends React.Component {
	...
	render() {
		if (!this.props.showing) return <div />;

		const thumbnails = this.state.article.thumbnails.map((thumb, index) => (
			<div key={index}>
				<a onClick={this.handleClick.bind(this, index)} href="#">
					<img
						src={this.state.article.baseUrl + "thumbnails/" + thumb}
					/>
				</a>
			</div>
		));
				...
				<div className="wrapper">
					<div className="images">
						...
						<div className="thumblist-wrapper">
							...
							<div className="thumblist">{thumbnails}</div>
							<span>
								<svg
									id="arrow-right"
									xmlns="http://www.w3.org/2000/svg"
					...
					<div className="information">
						...
						<p className="inc-tax">
							{addSpaceInPrice(article.priceIncTax)} / styck
						</p>
						<p className="ex-tax">
							({addSpaceInPrice(article.priceExTax)} kr exkl.
							moms)
						</p>
						<p>
